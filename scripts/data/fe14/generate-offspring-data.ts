...
const classProfiles: Record<string, ClassProfile> = {
  nohr_prince: profile("Nohr Prince / Princess", [17, 7, 3, 4, 5, 2, 5, 2], ["sword", "dragonstone"]),
  hoshido_noble: profile("Hoshido Noble", [19, 10, 4, 5, 6, 4, 7, 3], ["sword", "dragonstone", "staff"], [[5, "dragon_ward", "Dragon Ward"], [15, "hoshidan_unity", "Hoshidan Unity"]]),
  nohr_noble: profile("Nohr Noble", [18, 8, 6, 4, 7, 2, 6, 6], ["sword", "dragonstone", "tome"], [[5, "draconic_hex", "Draconic Hex"], [15, "nohrian_trust", "Nohrian Trust"]]),
  cavalier: profile("Cavalier", [17, 6, 0, 5, 5, 3, 5, 3], ["lance", "sword"]),
  paladin: profile("Paladin", [19, 8, 1, 7, 7, 4, 7, 6], ["lance", "sword"], [[5, "defender", "Defender"], [15, "aegis", "Aegis"]]),
  great_knight: profile("Great Knight", [21, 10, 0, 6, 6, 3, 10, 2], ["lance", "sword", "axe"], [[5, "luna", "Luna"], [15, "armored_blow", "Armored Blow"]]),
  apothecary: profile("Apothecary", [18, 6, 0, 4, 4, 2, 6, 2], ["bow"]),
  merchant: profile("Merchant", [20, 8, 0, 6, 5, 4, 8, 5], ["bow", "lance"], [[5, "profiteer", "Profiteer"], [15, "spendthrift", "Spendthrift"]]),
  mechanist: profile("Mechanist", [18, 7, 0, 9, 7, 2, 6, 6], ["dagger", "bow"], [[5, "golembane", "Golembane"], [15, "replicate", "Replicate"]]),
  spear_fighter: profile("Spear Fighter", [17, 6, 0, 6, 6, 2, 5, 2], ["lance"]),
  spear_master: profile("Spear Master", [18, 9, 0, 8, 8, 3, 7, 3], ["lance"], [[5, "seal_speed", "Seal Speed"], [15, "lancefaire", "Lancefaire"]]),
  basara: profile("Basara", [20, 7, 5, 7, 7, 5, 7, 6], ["lance", "tome"], [[5, "rend_heaven", "Rend Heaven"], [15, "quixotic", "Quixotic"]]),
  archer: profile("Archer", [17, 5, 0, 7, 5, 2, 4, 1], ["bow"]),
  sniper: profile("Sniper", [19, 7, 0, 10, 9, 3, 6, 2], ["bow"], [[5, "certain_blow", "Certain Blow"], [15, "bowfaire", "Bowfaire"]]),
  kinshi_knight: profile("Kinshi Knight", [17, 4, 1, 9, 8, 5, 4, 7], ["bow", "lance"], [[5, "air_superiority", "Air Superiority"], [15, "amaterasu", "Amaterasu"]]),
  ninja: profile("Ninja", [16, 3, 0, 8, 8, 1, 3, 3], ["dagger"]),
  master_ninja: profile("Master Ninja", [17, 5, 0, 10, 11, 2, 4, 8], ["dagger"], [[5, "lethality", "Lethality"], [15, "shurikenfaire", "Shurikenfaire"]]),
  kitsune: profile("Kitsune", [16, 5, 1, 6, 8, 4, 1, 4], ["beaststone"]),
  nine_tails: profile("Nine-Tails", [19, 6, 2, 9, 10, 5, 2, 8], ["beaststone"], [[5, "even_better", "Even Better"], [15, "grisly_wound", "Grisly Wound"]]),
  samurai: profile("Samurai", [17, 4, 0, 5, 8, 3, 3, 3], ["sword"]),
  swordmaster: profile("Swordmaster", [18, 6, 2, 7, 11, 4, 5, 5], ["sword"], [[5, "astra", "Astra"], [15, "swordfaire", "Swordfaire"]]),
  master_of_arms: profile("Master of Arms", [20, 8, 0, 6, 9, 3, 7, 3], ["sword", "lance", "axe"], [[5, "seal_strength", "Seal Strength"], [15, "life_and_death", "Life and Death"]]),
  shrine_maiden: profile("Shrine Maiden", [16, 0, 3, 5, 5, 4, 2, 5], ["staff"]),
  priestess: profile("Priestess", [19, 6, 7, 6, 9, 5, 5, 8], ["staff", "bow"], [[5, "renewal", "Renewal"], [15, "countermagic", "Countermagic"]]),
  onmyoji: profile("Onmyoji", [16, 0, 7, 6, 7, 2, 3, 6], ["tome", "staff"], [[5, "rally_magic", "Rally Magic"], [15, "tomefaire", "Tomefaire"]]),
  troubadour: profile("Troubadour", [15, 0, 3, 7, 5, 4, 1, 4], ["staff"]),
  strategist: profile("Strategist", [16, 0, 7, 6, 7, 5, 2, 7], ["staff", "tome"], [[5, "rally_resistance", "Rally Resistance"], [15, "inspiration", "Inspiration"]]),
  attendant: profile("Butler", [18, 4, 5, 9, 8, 4, 5, 4], ["staff", "dagger"], [[5, "live_to_serve", "Live to Serve"], [15, "tomebreaker", "Tomebreaker"]]),
  sky_knight: profile("Sky Knight", [16, 3, 0, 5, 7, 4, 2, 6], ["lance"]),
  falcon_knight: profile("Falcon Knight", [18, 5, 4, 6, 10, 5, 5, 9], ["lance", "staff"], [[5, "rally_speed", "Rally Speed"], [15, "warding_blow", "Warding Blow"]]),
  diviner: profile("Diviner", [15, 0, 4, 5, 6, 1, 1, 3], ["tome"]),
  knight: profile("Knight", [19, 8, 0, 5, 3, 3, 8, 1], ["lance"]),
  general: profile("General", [22, 11, 0, 7, 3, 4, 12, 3], ["lance", "axe"], [[5, "wary_fighter", "Wary Fighter"], [15, "pavise", "Pavise"]]),
  wolfskin: profile("Wolfskin", [19, 8, 0, 4, 6, 0, 4, 0], ["beaststone"]),
  wolfssegner: profile("Wolfssegner", [22, 11, 0, 6, 7, 1, 7, 1], ["beaststone"], [[5, "better_odds", "Better Odds"], [15, "grisly_wound", "Grisly Wound"]]),
  wyvern_rider: profile("Wyvern Rider", [17, 6, 0, 5, 4, 2, 7, 0], ["axe"]),
  wyvern_lord: profile("Wyvern Lord", [19, 8, 0, 9, 6, 3, 10, 1], ["axe", "lance"], [[5, "rally_defense", "Rally Defense"], [15, "swordbreaker", "Swordbreaker"]]),
  malig_knight: profile("Malig Knight", [18, 7, 6, 6, 5, 0, 8, 6], ["axe", "tome"], [[5, "savage_blow", "Savage Blow"], [15, "trample", "Trample"]]),
  dark_mage: profile("Dark Mage", [16, 0, 6, 3, 3, 1, 3, 5], ["tome"]),
  sorcerer: profile("Sorcerer", [17, 0, 9, 4, 6, 1, 5, 8], ["tome"], [[5, "vengeance", "Vengeance"], [15, "bowbreaker", "Bowbreaker"]]),
  dark_knight: profile("Dark Knight", [19, 8, 6, 6, 5, 3, 8, 6], ["tome", "sword"], [[5, "seal_magic", "Seal Magic"], [15, "lifetaker", "Lifetaker"]]),
  mercenary: profile("Mercenary", [17, 5, 0, 7, 6, 2, 5, 2], ["sword"]),
  hero: profile("Hero", [20, 8, 0, 10, 8, 3, 7, 2], ["sword", "axe"], [[5, "sol", "Sol"], [15, "axebreaker", "Axebreaker"]]),
  bow_knight: profile("Bow Knight", [18, 6, 0, 8, 9, 3, 5, 6], ["sword", "bow"], [[5, "rally_skill", "Rally Skill"], [15, "shurikenbreaker", "Shurikenbreaker"]]),
  outlaw: profile("Outlaw", [16, 3, 1, 4, 8, 1, 2, 4], ["bow"]),
  adventurer: profile("Adventurer", [17, 4, 6, 6, 10, 2, 3, 8], ["bow", "staff"], [[5, "lucky_seven", "Lucky Seven"], [15, "pass", "Pass"]]),
};

function profile(displayName: string, base: number[], weapons: string[], skills: Array<[number, string, string]> = []): ClassProfile {
  return { displayName, base: stats(base), weapons, skills };
}
  ...
  const generatedRecruitment = generatedChildren.map((child) => {
    ...
    const promotionOptions = tree.promotions.map((promotion: any) => {
      ...
      return {
        ...
        learnedSkills: promoted.skills.map(([level, skillId]) => ({ level, skillId })),
      };
    });
    return {
      unitId: child.id,
      ...
      provenance: [
        ...
        { sourceId: "fewiki-fe14-classes", locator: `${baseProfile.displayName} and promotion rows`, fields: ["offspringSeal.promotionOptions"], reviewStatus: "accepted" },
