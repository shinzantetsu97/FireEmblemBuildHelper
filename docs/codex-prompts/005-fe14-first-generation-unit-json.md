...
- Castle recruits Izana, Yukimura, Flora, and Fuga use the game's map-level autolevel system. Flora and Izana compare the applicable chapter map level against internal level 28 and grow from promoted level 5; Yukimura and Fuga compare against internal level 33 and grow from promoted level 10. The full Chapter 19-27 level schedules are explicit. This mechanic was identified and explained by FE14 modder ltranc@; exact weapon-rank milestones remain unresolved.
...
- Known unresolved mechanics remain prose-level limitations instead of invented precision. These include exact weapon-rank milestones for map-level castle recruits and whether Gunter's early EXP, level, and weapon proficiency carry into later appearances.
